...
find_package_handle_standard_args(
  Execinfo
  FOUND_VAR EXECINFO_FOUND
  REQUIRED_VARS EXECINFO_INCLUDE_DIR)
...
if(EXECINFO_FOUND AND NOT TARGET Execinfo::Execinfo)
  if(EXECINFO_LIBRARY)
    ...
    set_target_properties(Execinfo::Execinfo PROPERTIES IMPORTED_LOCATION
                                                        "${EXECINFO_LIBRARY}")
  else()
    add_library(Execinfo::Execinfo INTERFACE IMPORTED)
  endif()
  set_target_properties(
    Execinfo::Execinfo PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
