...
#define TEST_SL_ASSERT_OPEN_RANDOMIZE(                                         \
  ...
  expect_event_open_re(0);                                                     \
  CPPUNIT_ASSERT(                                                              \
    sl->open_randomize(_sap_bind, _first_port, _last_port, _flags));           \
  CPPUNIT_ASSERT(sl->is_open());                                               \
  CPPUNIT_ASSERT(torrent::sa_equal(sl->socket_address(), _sap_result.get()));
...
test_socket_listen::test_open_sap_error() {
  ...
  {
    TEST_SL_BEGIN("unix");
    CPPUNIT_ASSERT_THROW(sl->open(torrent::sa_make_unix("test"),
                                  5000,
                                  5009,
                                  5005,
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(
      sl->open(torrent::sap_copy(sin_any_5005),
               5000,
               5009,
               5005,
               torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(sl->open(torrent::sap_copy(sin6_any_5005),
                                  5000,
                                  5009,
                                  5005,
                                  torrent::fd_flag_stream),
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(
      sl->open(torrent::sap_to_v4mapped(sin_any),
               5000,
               5009,
               5005,
               torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(
      sl->open(torrent::sap_to_v4mapped(sin_1),
               5000,
               5009,
               5005,
               torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(
      sl->open(torrent::sap_copy(sin_bc),
               5000,
               5009,
               5005,
               torrent::fd_flag_stream | torrent::fd_flag_v4only),
...
test_socket_listen::test_open_flags_error() {
  ...
  };
  {
    ...
    CPPUNIT_ASSERT_THROW(sl->open(torrent::sap_copy(sin6_any),
                                  5000,
                                  5009,
                                  5005,
...
test_socket_listen::test_accept() {
  {
    ...
    // CPPUNIT_ASSERT(accepted_connections.size() > 0 &&
