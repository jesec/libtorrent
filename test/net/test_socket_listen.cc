...
typedef std::unique_ptr<torrent::socket_listen, test_sl_deleter>
  test_sl_unique_ptr;
...
#define TEST_SL_ASSERT_OPEN_PORT(                                              \
  ...
  ASSERT_TRUE(                                                                 \
    sl->open(_sap_bind, _first_port, _last_port, _itr_port, _flags));          \
  ASSERT_TRUE(sl->is_open());                                                  \
  ASSERT_TRUE(torrent::sa_equal(sl->socket_address(), _sap_result.get()));

#define TEST_SL_ASSERT_OPEN_SEQUENTIAL(                                        \
...
TEST_F(test_socket_listen, test_basic) {
  TEST_SL_BEGIN("basic");
  TEST_SL_ASSERT_CLOSED();
  ASSERT_EQ(sl->backlog(), SOMAXCONN);
  ASSERT_EQ(sl->type_name(), std::string("socket_listen"));
}

TEST_F(test_socket_listen, test_open_error) {
  {
    TEST_SL_BEGIN("open twice");
    expect_fd_inet6_tcp_nonblock(1000);
    expect_fd_bind_listen(1000, c_sin6_any_5005);
    TEST_SL_ASSERT_OPEN(torrent::sap_copy(sin6_any),
                        c_sin6_any_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_nonblock);
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 5000, 5009, 5005, torrent::fd_flag_stream),
  ...
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin_any), 5000, 5009, 5005, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
}

TEST_F(test_socket_listen, test_open_sap) {
  {
    TEST_SL_BEGIN("sin6_any, stream");
    expect_fd_inet6_tcp(1000);
    expect_fd_bind_listen(1000, c_sin6_any_5005);
    TEST_SL_ASSERT_OPEN(
      torrent::sap_copy(sin6_any), c_sin6_any_5005, torrent::fd_flag_stream);
    TEST_SL_CLOSE(1000);
  };
  {
    ...
    TEST_SL_ASSERT_OPEN(torrent::sap_copy(sin_any),
                        c_sin_any_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_v4only);
    TEST_SL_CLOSE(1000);
  };
  {
    ...
    TEST_SL_ASSERT_OPEN(torrent::sap_copy(sin_1),
                        c_sin_1_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_v4only);
    TEST_SL_CLOSE(1000);
  };
  {
    ...
    expect_fd_inet6_tcp(1000);
    mock_expect(&torrent::fd__setsockopt_int,
                0,
                1000,
                (int)IPPROTO_IPV6,
                (int)IPV6_V6ONLY,
    ...
    TEST_SL_ASSERT_OPEN(torrent::sap_copy(sin6_any),
                        c_sin6_any_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_v6only);
    TEST_SL_CLOSE(1000);
  };
  {
    ...
    TEST_SL_ASSERT_OPEN(torrent::sap_copy(sin6_1),
                        c_sin6_1_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_v6only);
    TEST_SL_CLOSE(1000);
  };
...
TEST_F(test_socket_listen, test_open_sap_error) {
  {
    TEST_SL_BEGIN("unspec");
    ASSERT_THROW(
      sl->open(
        torrent::sa_make_unspec(), 5000, 5009, 5005, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    TEST_SL_BEGIN("unix");
    ASSERT_THROW(sl->open(torrent::sa_make_unix("test"),
                          5000,
                          5009,
                          5005,
  ...
  };
  {
    ...
    ASSERT_THROW(sl->open(torrent::sap_copy(sin_any_5005),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    ASSERT_THROW(sl->open(torrent::sap_copy(sin6_any_5005),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flag_stream),
  ...
  };
  {
    ...
    ASSERT_THROW(sl->open(torrent::sap_to_v4mapped(sin_any),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    ASSERT_THROW(sl->open(torrent::sap_to_v4mapped(sin_1),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flag_stream | torrent::fd_flag_v4only),
  ...
  };
  {
    ...
    ASSERT_THROW(sl->open(torrent::sap_copy(sin_bc),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flag_stream | torrent::fd_flag_v4only),
...
TEST_F(test_socket_listen, test_open_flags) {
  {
    TEST_SL_BEGIN("sin_any, stream|v4only|nonblock");
    expect_fd_inet_tcp_nonblock(1000);
    expect_fd_bind_listen(1000, c_sin_any_5005);
    TEST_SL_ASSERT_OPEN(torrent::sap_copy_addr(sin_any),
                        c_sin_any_5005,
                        torrent::fd_flag_stream | torrent::fd_flag_v4only |
...
TEST_F(test_socket_listen, test_open_flags_error) {
  {
    TEST_SL_BEGIN("sin6_any, fd_flags(0)");
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 5000, 5009, 5005, torrent::fd_flags(0)),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    TEST_SL_BEGIN("sin6_any, fd_flags(0xffff)");
    ASSERT_THROW(sl->open(torrent::sap_copy(sin6_any),
                          5000,
                          5009,
                          5005,
                          torrent::fd_flags(0xffff)),
                 torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
}

TEST_F(test_socket_listen, test_open_port_single) {
  {
    TEST_SL_BEGIN("sin6_any, stream");
    expect_fd_inet6_tcp(1000);
    expect_fd_bind_listen(1000, c_sin6_any_5000);
    TEST_SL_ASSERT_OPEN_PORT(torrent::sap_copy(sin6_any),
                             c_sin6_any_5000,
                             5000,
                             5000,
                             5000,
  ...
  };
  {
    ...
    TEST_SL_ASSERT_OPEN_PORT(torrent::sap_copy(sin_any),
                             c_sin_any_5000,
                             5000,
                             5000,
                             5000,
...
TEST_F(test_socket_listen, test_open_port_single_error) {
  {
    TEST_SL_BEGIN("sin6_any, 0, 0, 0");
    ASSERT_THROW(
      sl->open(torrent::sap_copy(sin6_any), 0, 0, 0, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 1000, 0, 0, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 0, 1000, 0, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(torrent::sap_copy(sin6_any), 0, 0, 500, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 0, 1000, 500, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
}

TEST_F(test_socket_listen, test_open_port_range) {
  {
...
TEST_F(test_socket_listen, test_open_port_range_error) {
  {
    TEST_SL_BEGIN("sin6_any, first > last");
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 5000, 4999, 5000, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 5001, 5009, 5000, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 5000, 5009, 5010, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(torrent::sap_copy(sin6_any), 2, 1, 2, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(
        torrent::sap_copy(sin6_any), 2, 1000, 1, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
    ...
    ASSERT_THROW(
      sl->open(torrent::sap_copy(sin6_any), 1, 2, 3, torrent::fd_flag_stream),
      torrent::internal_error);
    TEST_SL_ASSERT_CLOSED();
  };
  {
...
TEST_F(test_socket_listen, test_open_sequential) {
  {
    TEST_SL_BEGIN("sin6_any, stream");
    expect_fd_inet6_tcp(1000);
    expect_fd_bind_listen(1000, c_sin6_any_5000);
    TEST_SL_ASSERT_OPEN_SEQUENTIAL(torrent::sap_copy(sin6_any),
                                   c_sin6_any_5000,
                                   5000,
                                   5010,
                                   torrent::fd_flag_stream);
...
TEST_F(test_socket_listen, test_accept) {
  {
    TEST_SL_BEGIN("sin6_any, stream");
    expect_fd_inet6_tcp(1000);
    expect_fd_bind_listen(1000, c_sin6_any_5000);
    ...
    sl->set_slot_accepted(
      [&accepted_connections](int accept_fd, torrent::sa_unique_ptr sap) {
        accepted_connections.push_back(
