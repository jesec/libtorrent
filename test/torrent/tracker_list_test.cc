...
tracker_list_test::test_basic() {
  ...
  CPPUNIT_ASSERT(tracker_list.find_usable(tracker_list.begin()) !=
                 tracker_list.end());
}
...
tracker_list_test::test_tracker_flags() {
  ...
  CPPUNIT_ASSERT(
    (tracker_list[0]->flags() & torrent::Tracker::mask_base_flags) ==
    torrent::Tracker::flag_enabled);
  CPPUNIT_ASSERT(
    (tracker_list[1]->flags() & torrent::Tracker::mask_base_flags) == 0);
  CPPUNIT_ASSERT(
    (tracker_list[2]->flags() & torrent::Tracker::mask_base_flags) ==
    torrent::Tracker::flag_enabled);
  CPPUNIT_ASSERT(
    (tracker_list[3]->flags() & torrent::Tracker::mask_base_flags) ==
    torrent::Tracker::flag_extra_tracker);
  CPPUNIT_ASSERT(
...
tracker_list_test::test_can_scrape() {
  ...
  CPPUNIT_ASSERT(torrent::Tracker::scrape_url_from(
                   tracker_list.back()->url()) == "http://example.com/scrape");

  tracker_list.insert_url(0, "http://example.com/x/announce");
  CPPUNIT_ASSERT(
    (tracker_list.back()->flags() & torrent::Tracker::flag_can_scrape));
  CPPUNIT_ASSERT(
    torrent::Tracker::scrape_url_from(tracker_list.back()->url()) ==
...
tracker_list_test::test_single_success() {
  ...
  CPPUNIT_ASSERT(tracker_0->is_busy_not_scrape());
  CPPUNIT_ASSERT(tracker_0->is_open());
  CPPUNIT_ASSERT(tracker_0->requesting_state() ==
