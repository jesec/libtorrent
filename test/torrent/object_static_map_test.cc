...
ObjectStaticMapTest::test_read() {
  ...
  CPPUNIT_ASSERT(
    static_map_read_bencode(test_skip_map, test_read_skip_bencode));
}
...
ObjectStaticMapTest::test_read_single_raw() {
  ...
  CPPUNIT_ASSERT(torrent::raw_bencode_equal_c_str(
...
ObjectStaticMapTest::test_read_raw_types() {
  ...
  CPPUNIT_ASSERT(static_map_read_bencode(map_raw,
                                         "d"
                                         "1:ei1e"
                                         "1:lli1ei2ee"
                                         "1:md1:ai1e1:bi2ee"
...
ObjectStaticMapTest::test_read_multiple() {
  ...
  CPPUNIT_ASSERT(map_normal[key_multiple_a].as_value() == 1);
  //   CPPUNIT_ASSERT(map_normal[key_multiple_b].as_raw_bencode().as_raw_value().size()
  //   == 1);
  //   CPPUNIT_ASSERT(map_normal[key_multiple_b].as_raw_bencode().as_raw_value().data()[0]
  //   == '2');
  CPPUNIT_ASSERT(map_normal[key_multiple_c].as_value() == 3);
}
