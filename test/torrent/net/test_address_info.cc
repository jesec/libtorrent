...
test_address_info::test_basic() {
  CPPUNIT_ASSERT(
    test_valid_ai_ref<aif_inet | aif_any>(std::bind(torrent::ai_get_addrinfo,
                                                    ...
                                                    nullptr,
                                                    std::placeholders::_1)));
  CPPUNIT_ASSERT(test_valid_ai_ref<aif_inet6 | aif_any>(std::bind(
    torrent::ai_get_addrinfo, "::", nullptr, nullptr, std::placeholders::_1)));

  CPPUNIT_ASSERT(test_valid_ai_ref<aif_inet>(std::bind(torrent::ai_get_addrinfo,
                                                       "1.1.1.1",
                                                       nullptr,
                                                       nullptr,
                                                       std::placeholders::_1)));
  CPPUNIT_ASSERT(
    test_valid_ai_ref<aif_inet6>(std::bind(torrent::ai_get_addrinfo,
                                           "ff01::1",
                                           nullptr,
                                           nullptr,
                                           std::placeholders::_1)));
  CPPUNIT_ASSERT(test_valid_ai_ref<aif_inet6>(
  ...
  CPPUNIT_ASSERT(test_valid_ai_ref<aif_none>(std::bind(torrent::ai_get_addrinfo,
                                                       "localhost",
                                                       nullptr,
                                                       nullptr,
                                                       std::placeholders::_1)));

  CPPUNIT_ASSERT(test_valid_ai_ref_err(std::bind(torrent::ai_get_addrinfo,
                                                 "1.1.1.300",
                                                 nullptr,
                                                 nullptr,
                                                 std::placeholders::_1),
...
test_address_info::test_numericserv() {
  CPPUNIT_ASSERT(test_valid_ai_ref<aif_inet>(
    std::bind(torrent::ai_get_addrinfo,
              "1.1.1.1",
              nullptr,
  ...
  CPPUNIT_ASSERT(test_valid_ai_ref_err(
    std::bind(torrent::ai_get_addrinfo,
              "localhost",
              nullptr,
              torrent::ai_make_hint(AI_NUMERICHOST, 0, 0).get(),
...
test_address_info::test_helpers() {
  ...
  CPPUNIT_ASSERT(
    compare_sin6_addr(sin6_zero->sin6_addr, in6_addr{ { { 0 } } }));
  ...
  CPPUNIT_ASSERT(compare_sin6_addr(
    sin6_1->sin6_addr,
