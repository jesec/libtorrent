...
test_socket_address::test_make() {
  ...
  CPPUNIT_ASSERT(
    compare_sin6_addr(sin6_inet6->sin6_addr, in6_addr{ { { 0 } } }));
...
test_socket_address::test_sin_from_sa() {
  ...
  CPPUNIT_ASSERT_NO_THROW(
    { sin_zero = torrent::sin_from_sa(std::move(sa_zero)); });
  CPPUNIT_ASSERT(sa_zero == nullptr);
  ...
  CPPUNIT_ASSERT(sa_inet != nullptr);
  CPPUNIT_ASSERT_NO_THROW(
    { sin_inet = torrent::sin_from_sa(std::move(sa_inet)); });
  CPPUNIT_ASSERT(sa_inet == nullptr);
  CPPUNIT_ASSERT(sin_inet != nullptr);

  CPPUNIT_ASSERT(sin_inet->sin_addr.s_addr == htonl(0x01020304));

  CPPUNIT_ASSERT_THROW(torrent::sin_from_sa(torrent::sa_unique_ptr()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sin_from_sa(torrent::sa_make_unspec()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sin_from_sa(torrent::sa_make_inet6()),
                       torrent::internal_error);
}
...
test_socket_address::test_sin6_from_sa() {
  ...
  CPPUNIT_ASSERT(sa_zero != nullptr);
  CPPUNIT_ASSERT_NO_THROW(
    { sin6_zero = torrent::sin6_from_sa(std::move(sa_zero)); });
  CPPUNIT_ASSERT(sa_zero == nullptr);
  ...
  CPPUNIT_ASSERT(sa_inet6 != nullptr);
  CPPUNIT_ASSERT_NO_THROW(
    { sin6_inet6 = torrent::sin6_from_sa(std::move(sa_inet6)); });
  CPPUNIT_ASSERT(sa_inet6 == nullptr);
  ...
  CPPUNIT_ASSERT_THROW(torrent::sin6_from_sa(torrent::sa_unique_ptr()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sin6_from_sa(torrent::sa_make_unspec()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sin6_from_sa(torrent::sa_make_inet()),
                       torrent::internal_error);
}
...
test_socket_address::test_sa_equal() {
  ...
  CPPUNIT_ASSERT_THROW(
    ...
    torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_equal(torrent::sa_make_unix(""), sin6_1),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_equal(sin6_1, torrent::sa_make_unix("")),
                       torrent::internal_error);
}
...
test_socket_address::test_sa_equal_addr() {
  ...
  CPPUNIT_ASSERT(torrent::sap_equal_addr(torrent::sa_make_unspec(),
                                         torrent::sa_make_unspec()));
  CPPUNIT_ASSERT(
    torrent::sap_equal_addr(torrent::sa_make_inet(), torrent::sa_make_inet()));
  CPPUNIT_ASSERT(torrent::sap_equal_addr(torrent::sa_make_inet6(),
  ...
  CPPUNIT_ASSERT(!torrent::sap_equal_addr(torrent::sa_make_unspec(),
                                          torrent::sa_make_inet6()));
  CPPUNIT_ASSERT(!torrent::sap_equal_addr(torrent::sa_make_inet(),
                                          torrent::sa_make_inet6()));
  CPPUNIT_ASSERT(!torrent::sap_equal_addr(torrent::sa_make_inet6(),
                                          torrent::sa_make_inet()));
  ...
  CPPUNIT_ASSERT_THROW(torrent::sap_equal_addr(torrent::sa_make_unix(""),
                                               torrent::sa_make_unix("")),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(
    torrent::sap_equal_addr(torrent::sa_make_unix(""), sin6_1),
    torrent::internal_error);
  CPPUNIT_ASSERT_THROW(
    torrent::sap_equal_addr(sin6_1, torrent::sa_make_unix("")),
    torrent::internal_error);
}
...
test_socket_address::test_sa_copy() {
  ...
  CPPUNIT_ASSERT(torrent::sap_equal(
    torrent::sap_copy(torrent::sa_make_unspec()), torrent::sa_make_unspec()));
  CPPUNIT_ASSERT(
  ...
  CPPUNIT_ASSERT(
    torrent::sap_equal(torrent::sap_copy(sin6_1_5000), sin6_1_5000));
  ...
  CPPUNIT_ASSERT_THROW(torrent::sap_copy(torrent::sa_unique_ptr()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_copy(torrent::c_sa_unique_ptr()),
                       torrent::internal_error);
}
...
test_socket_address::test_sa_copy_addr() {
  ...
  CPPUNIT_ASSERT(torrent::sap_copy_addr(sin6_1_5000).get() !=
                 sin6_1_5000.get());
  ...
  CPPUNIT_ASSERT(
    torrent::sap_equal(torrent::sap_copy_addr(c_sin6_1), c_sin6_1));
  CPPUNIT_ASSERT(
  ...
  CPPUNIT_ASSERT(
    torrent::sap_equal(torrent::sap_copy_addr(sin6_1_5000), sin6_1));
  CPPUNIT_ASSERT(
  ...
  CPPUNIT_ASSERT(
    torrent::sap_equal(torrent::sap_copy_addr(sin6_flags), sin6_1));

  CPPUNIT_ASSERT_THROW(torrent::sap_copy_addr(torrent::sa_unique_ptr()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_copy_addr(torrent::c_sa_unique_ptr()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_copy_addr(torrent::sa_unique_ptr(), 5000),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_copy_addr(torrent::c_sa_unique_ptr(), 5000),
                       torrent::internal_error);
}
...
test_socket_address::test_sa_from_v4mapped() {
  ...
  CPPUNIT_ASSERT(
    torrent::sap_is_port_any(torrent::sap_from_v4mapped(sin6_v4_1)));

  CPPUNIT_ASSERT(
    torrent::sap_equal_addr(torrent::sap_from_v4mapped(sin6_v4_bc), sin_bc));
  CPPUNIT_ASSERT(
    torrent::sap_is_port_any(torrent::sap_from_v4mapped(sin6_v4_bc)));

  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(torrent::sa_make_unspec()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(torrent::sa_make_inet()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(torrent::sa_make_unix("")),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(sin_any),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(sin_bc),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_from_v4mapped(sin_1),
                       torrent::internal_error);
}
...
test_socket_address::test_sa_to_v4mapped() {
  ...
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(torrent::sa_make_unspec()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(torrent::sa_make_inet6()),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(torrent::sa_make_unix("")),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(sin6_any),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(sin6_1),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(sin6_v4_any),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(sin6_v4_bc),
                       torrent::internal_error);
  CPPUNIT_ASSERT_THROW(torrent::sap_to_v4mapped(sin6_v4_1),
                       torrent::internal_error);
}
