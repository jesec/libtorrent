...
do_test_hammering_basic(bool     success1,
  ...
  CPPUNIT_ASSERT(success1 ? tracker_0_0->trigger_success()
  ...
  CPPUNIT_ASSERT(tracker_0_0->is_busy());
  CPPUNIT_ASSERT(success3 ? tracker_0_0->trigger_success()
                          : tracker_0_0->trigger_failure());
...
do_test_hammering_multi3(bool     success1,
  ...
  if (success2) {
    ...
    CPPUNIT_ASSERT(test_goto_next_timeout(&tracker_controller, 30));
    CPPUNIT_ASSERT(
      test_goto_next_timeout(&tracker_controller, next_timeout - 30));
