...
public:
  ...
  // void startTestRun(CppUnit::Test *test, CppUnit::TestResult *event_manager)
  // override;

  // Called by a TestRunner after running the test.
  // void endTestRun(CppUnit::Test *test, CppUnit::TestResult *event_manager)
  // override;

  const failure_list_type& failures() {
    return m_failures;
  }
