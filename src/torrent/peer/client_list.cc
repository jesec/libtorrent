...
ClientList::ClientList() {
  ...
  insert_helper(
    ClientInfo::TYPE_AZUREUS, "bk", NULL, NULL, "BitKitten (libtorrent)");
  ...
  insert_helper(
    ClientInfo::TYPE_AZUREUS, "DP", NULL, NULL, "Propogate Data Client");
  ...
  insert_helper(
    ClientInfo::TYPE_AZUREUS, "UE", NULL, NULL, "uTorrent Embedded");
  ...
  insert_helper(
    ClientInfo::TYPE_AZUREUS, "WD", NULL, NULL, "WebTorrent Desktop");
