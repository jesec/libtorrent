...
struct less2_t
  : public std::binary_function<typename FtorA::argument_type,
                                typename FtorB::argument_type,
                                bool> {
  less2_t(FtorA f_a, FtorB f_b)
    : m_f_a(f_a)
    , m_f_b(f_b) {}

  bool operator()(typename FtorA::argument_type a,
                  typename FtorB::argument_type b) {
...
struct greater2_t
  : public std::binary_function<typename FtorA::argument_type,
                                typename FtorB::argument_type,
                                bool> {
  greater2_t(FtorA f_a, FtorB f_b)
    : m_f_a(f_a)
    , m_f_b(f_b) {}
...
struct on_t
  : public std::unary_function<typename Src::argument_type,
                               typename Dest::result_type> {
  ...
  result_type operator()(
    typename reference_fix<typename Src::argument_type>::type arg) {
...
template<typename Src, typename Dest>
struct on2_t
  : public std::binary_function<typename Src::argument_type,
                                typename Dest::second_argument_type,
                                typename Dest::result_type> {
  typedef typename Dest::result_type result_type;
  ...
  result_type operator()(
    typename reference_fix<typename Src::argument_type>::type         first,
    typename reference_fix<typename Dest::second_argument_type>::type second) {
...
template<typename Class, typename Member>
struct const_mem_ref_t
  : public std::unary_function<const Class&, const Member&> {
  const_mem_ref_t(const Member Class::*m)
    : m_member(m) {}
...
public:
  typedef typename reference_fix<typename Operation::first_argument_type>::type
    value_type;
  typedef typename reference_fix<typename Operation::second_argument_type>::type
    argument_type;
  ...
  typename Operation::result_type operator()(const argument_type arg) {
...
public:
  ...
  typename Operation::result_type operator()(argument_type arg) {
...
public:
  ...
  const_mem_fun0()
    : m_object(NULL) {}
  const_mem_fun0(const Object* o, Function f)
    : m_object(o)
    , m_function(f) {}
...
public:
  ...
  const_mem_fun1()
    : m_object(NULL) {}
  const_mem_fun1(const Object* o, Function f)
    : m_object(o)
    , m_function(f) {}
...
public:
  ...
  Ret operator()(Arg1 a1, Arg2 a2) {
    return (m_object->*m_function)(a1, a2);
  }
...
public:
  ...
  Ret operator()(Arg1 a1, Arg2 a2, Arg3 a3) {
    return (m_object->*m_function)(a1, a2, a3);
  }
