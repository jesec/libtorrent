...
public:
  ...
  using slot_new_conn_type = PeerConnectionBase* (*)(bool);
...
private:
  ConnectionList(const ConnectionList&) LIBTORRENT_NO_EXPORT = delete;
  void operator=(const ConnectionList&) LIBTORRENT_NO_EXPORT = delete;
